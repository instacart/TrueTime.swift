...
*Make sure to check out our counterpart too: [TrueTime](https://github.com/instacart/truetime-android), an SNTP library for Android.*
...
* UDP requests are executed in parallel, with a default limit of 3 parallel calls. If one fails, we'll retry up to 5 times by default.
